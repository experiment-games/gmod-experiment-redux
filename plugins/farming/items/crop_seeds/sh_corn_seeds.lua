...
ITEM.stageConfig = {
	[1] = { modelScale = 0.6, bodygroup = 2, skin = 1, rotChance = 0 },
	[2] = { modelScale = 0.8, bodygroup = 2, skin = 1, rotChance = 1 },
...
ITEM.generateRottenItem = {
	uniqueID = "rotten_corn",
	name = "Rotten Corn",
	description = "A rotten ear of corn that is no longer usable.",
	model = "models/a31/fallout4/props/plants/corn_item.mdl",
	skin = 0
}
